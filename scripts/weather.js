...
// Callback for geolocation function
// @params Object returned pos data
...
// Function not needed now will be needed if implementing 
// time specific background\icons beyond what is provided by icon data
// from Forecast.IO
...
// Sets error alerts in main tray
// @params string error to be appeneded
...
// Sets Alert information for weather warnings 
// @params Object alert object
//         Number index number for the alert being triggered
...
// Returns HTML formated information for weather alerts modal
// @params Object weather alert object
...
// Returns converts UNIX timestamp to current data time 
// @params string UNIX formated timestamp 
...
// Returns formated time of day with AM PM indicators
// @params string UNIX formated timestamp
...
// Returns formated day of the week along with month and day
// @params string UNIX formated timestamp
...
// Returns percent corrected rain chance data
// @params object data object containing the rain chance
...
// ForcastIO object wrapper for API data inherits from Mediator obj 
// for customer event states
// @params string latitude and longitude of weather check
...
// Sets all weather data information 
// takes in ForcastIO object (necessary due to call back)
...
// Returns appropriate weather icon for icon data
// @params string icon data
...
// Returns appropriate weather background for icon data
// @params string icon data
...
// Creates the html for each of the extended forecast days
// @params object daily weather data
...
// Goggle maps object wrapper
// slimed down only needed function is reverse geocoding
